...
function handleServerRequest(request, response) {
    ...
    switch(urlParts.pathname){
        ...
        // Payments
        case '/get_payments':
            handlers.payments(urlParts, response);
            break;
        // Blocks
        case '/get_block':
            handlers.blocks.getBlock(urlParts, response);
            break;
        // Blocks
        case '/get_blocks':
            handlers.blocks.getBlocks(urlParts, response);
            break;
        ...
        // Top 10 miners
        case '/get_top10':
        	handlers.topminers(response);
        	break;
        
        // Miner settings
        case '/get_miner_payout_level':
            handlers.payouts.getMinerPayoutLevel(urlParts, response);
            break;
        case '/set_miner_payout_level':
            handlers.payouts.setMinerPayoutLevel(urlParts, response);
            break;
        ...
        case '/miners_scoresheet':
            handlers.scoresheets.miner(urlParts,response);
            break;
        case '/pool_scoresheet':
            handlers.scoresheets.pool(urlParts,response);
            break;
        // Pool Administration
        case '/admin_stats':
            if (!authorize(request, response))
