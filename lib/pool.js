...
function processBlockTemplate(template){
    ...
    asyc.each(connectedMiners,function(miner,minerId){
 ...
 * Job refresh
 **/
function jobRefresh(loop, callback,force){
    ...
    getBlockTemplate(function(error, result){
        ...
        if (force || !currentBlockTemplate || result.height > currentBlockTemplate.height || result.difficulty !== currentBlockTemplate.difficulty) {
