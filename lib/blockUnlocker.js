                ...
                redisClient.multi(getDonationCommands).exec(function(error, replies) {
                    ...
                    for(let i = 0,il=blockStatisticHeight.length;i<il;i++){
			    		...
			    		const shareSave = [
                            ...
                            unlockedBlocksCommands.push(["hmset",config.coin+":block_shares:"+height,wallet,shareSave]);
			   				unlockedBlocksCommands.push(["hmset",config.coin+":block_histories:"+wallet,height,shareSave]);
                        }
                    }
