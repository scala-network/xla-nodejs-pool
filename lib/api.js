...
function handleServerRequest(request, response) {
    ...
    switch(urlParts.pathname){
        ...
        // Top 10 miners
        case '/get_top10':
        	handlers.topminers.getHandler(response);
        	break;
        ...
        case '/reset_donation_level':
            ...
            redisClient.hset(config.coin + ':workers:' + address,'minPayoutLevel',0,function(err){
        ...
        case '/set_miner_payout_level':
            ...
            break;
        case '/get_heights':
            handlers.blocks.getHeights(urlParts,function(data){
                sendData(response,data);
            });
            break;
