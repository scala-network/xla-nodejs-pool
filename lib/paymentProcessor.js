                   ...
                   if(config.payments.minerPayFee){
                        if(config.payments.dynamicTransferFee){
                            ...
                            for(let d in oldDestinations){
                                ...
                                let newFee = transferFee * scoreAmount;//if fee is 10XTL you pay 1XTL only
                                let newDestAmount = parseFloat(oldAmount) - parseFloat(newFee);//This is you new value at oldAmount - newFee
